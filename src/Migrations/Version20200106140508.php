 ...
 */
final class Version20200106140508 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE t_entite_administrative ADD fkEntitemere VARCHAR(50) DEFAULT NULL, DROP fk_entitemere, CHANGE IdEntite IdEntite VARCHAR(50) NOT NULL');
        ...
        $this->addSql('DROP INDEX FK_59EE4F46FD4B1056 ON t_territorial');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE t_entite_administrative ADD fk_entitemere VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP fkEntitemere, CHANGE IdEntite IdEntite VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE INDEX FK_59EE4F46FD4B1056 ON t_territorial (Fk_TypeTerritorial)');
