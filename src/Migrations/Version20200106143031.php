 ...
 */
final class Version20200106143031 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE t_entite_administrative ADD fk_entitemere VARCHAR(255) NOT NULL, DROP fkEntitemere, CHANGE IdEntite IdEntite VARCHAR(50) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE t_entite_administrative ADD fkEntitemere VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP fk_entitemere, CHANGE IdEntite IdEntite VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
